        ...
        public object AfterReceiveRequest(ref Message request, IClientChannel channel, InstanceContext instanceContext)
        {
            if (request.Properties.ContainsKey("UriTemplateMatchResults"))
            {
                ...
                if ("json".Equals(format, StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    //httpmsg.Headers["Accept-Encoding"] = "gzip,deflate,sdch";

                    //httpmsg.Headers["Accept-Language"] = "en-US,en;q=0.8";

                    //httpmsg.Headers["Accept-Charset"] = "ISO-8859-1,utf-8;q=0.7,*;q=0.3";
